...
const messageScore = {
    score: 0,
    title: document.querySelector('.score'),

    initMessage() {
        this.title.innerHTML = '';
        const msg = document.createElement('h3');
        msg.textContent = `Очки: ${String(this.score)}`;
        this.title.appendChild(msg);
    }
}
